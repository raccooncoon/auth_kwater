      ...
      <div className="bg-slate-950 border border-slate-800 p-8 rounded-2xl space-y-3">
        ...
        <div className="flex flex-col items-center">
          <div className="w-full max-w-md bg-gradient-to-br from-sky-950/80 to-slate-900 border-2 border-sky-500/60 rounded-2xl p-5 flex flex-col items-center text-center shadow-lg shadow-sky-500/10 relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-sky-500 text-white text-[14px] px-3 py-0.5 rounded-full font-bold tracking-wider uppercase">Upstream IdP</div>
        ...
        <div className="flex flex-col items-center gap-2 py-4">
          ...
          <span className="text-[15px] font-mono text-sky-200 bg-sky-950/90 border border-sky-500/40 px-3 py-1 rounded-full shadow-md">
        ...
        <div className="flex flex-col items-center">
          <div className="w-full max-w-md bg-gradient-to-br from-indigo-950/80 to-slate-900 border-2 border-indigo-500 rounded-2xl p-5 flex flex-col items-center text-center shadow-xl shadow-indigo-500/10 relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-indigo-500 text-white text-[14px] px-3 py-0.5 rounded-full font-bold tracking-wider uppercase">SSO IdP Hub</div>
            <Server className="text-indigo-400 my-2" size={36} />
            <h4 className="font-bold text-white text-base">디지털플랫폼 통합인증 서버</h4>
            <span className="text-[15px] text-emerald-400 font-mono mt-1">auth.kwater.com</span>
            <div className="w-full h-px bg-slate-800 my-3"></div>
            <span className="text-[15px] text-indigo-300 font-bold bg-indigo-950/80 px-2.5 py-1 rounded border border-indigo-800">디지털플랫폼 SSO Session Cookie</span>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-2 py-4">
          ...
          <span className="text-[15px] font-mono text-indigo-200 bg-indigo-950/90 border border-indigo-500/40 px-3 py-1 rounded-full shadow-md">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-slate-900 border border-indigo-500/40 rounded-2xl p-4 flex flex-col items-center text-center shadow-lg relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-800 text-indigo-300 text-[14px] px-2.5 py-0.5 rounded-full font-bold tracking-wider uppercase border border-indigo-500/40 whitespace-nowrap">Master · 권한 허브</div>
            <Laptop className="text-indigo-400 my-2" size={26} />
            <h4 className="font-bold text-white text-[15px]">클라우드 관리 포털 (CMP)</h4>
            <span className="text-[14px] text-slate-500 mt-1 font-mono">cmp.kwater.com</span>
            <div className="w-full h-px bg-slate-800 my-2.5"></div>
            <p className="text-[14px] text-slate-400 leading-relaxed">K-water 페이로드 최초 진입 + <strong className="text-indigo-300">전사 권한 신청·승인 허브</strong></p>
          </div>
          ...
          <div className="bg-slate-900 border border-emerald-500/40 rounded-2xl p-4 flex flex-col items-center text-center shadow-lg relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-800 text-emerald-300 text-[14px] px-2.5 py-0.5 rounded-full font-bold tracking-wider uppercase border border-emerald-500/40 whitespace-nowrap">Sub Client</div>
            <Database className="text-emerald-400 my-2" size={26} />
            <h4 className="font-bold text-white text-[15px]">데이터허브 포털</h4>
            <span className="text-[14px] text-slate-500 mt-1 font-mono">datahub.kwater.com</span>
            <div className="w-full h-px bg-slate-800 my-2.5"></div>
            <p className="text-[14px] text-slate-400 leading-relaxed">전용 client_id로 데이터허브 API 권한 토큰 발급</p>
          </div>
          ...
          <div className="bg-slate-900 border border-purple-500/40 rounded-2xl p-4 flex flex-col items-center text-center shadow-lg relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-800 text-purple-300 text-[14px] px-2.5 py-0.5 rounded-full font-bold tracking-wider uppercase border border-purple-500/40 whitespace-nowrap">Sub Client</div>
            <Sparkles className="text-purple-400 my-2" size={26} />
            <h4 className="font-bold text-white text-[15px]">생성형 AI 포털</h4>
            <span className="text-[14px] text-slate-500 mt-1 font-mono">genai.kwater.com</span>
            <div className="w-full h-px bg-slate-800 my-2.5"></div>
            <p className="text-[14px] text-slate-400 leading-relaxed">LLM/AI 서비스 전용 Scope 부여 및 무중단 로그인</p>
          </div>
          ...
          <div className="bg-slate-900 border border-amber-500/40 rounded-2xl p-4 flex flex-col items-center text-center shadow-lg relative">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-slate-800 text-amber-300 text-[14px] px-2.5 py-0.5 rounded-full font-bold tracking-wider uppercase border border-amber-500/40 whitespace-nowrap">Sub Client</div>
            <Boxes className="text-amber-400 my-2" size={26} />
            <h4 className="font-bold text-white text-[15px]">SaaS 포털</h4>
            <span className="text-[14px] text-slate-500 mt-1 font-mono">saas.kwater.com</span>
            <div className="w-full h-px bg-slate-800 my-2.5"></div>
            <p className="text-[14px] text-slate-400 leading-relaxed">SaaS 카탈로그 및 라이선스 관리용 토큰 자동 발급</p>
          </div>
        </div>
          ...
          <div className="p-6 space-y-5">
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-2 flex items-center gap-2">
                <span className="bg-emerald-500/20 text-emerald-300 text-[14px] font-mono px-2 py-0.5 rounded">WHEN</span>
                시점별 로그인 동작
              </h5>
                ...
                <table className="w-full text-left text-xs border-collapse text-slate-300">
                  ...
                  <tbody className="divide-y divide-slate-800/40">
                    <tr>
                      ...
                      <td className="py-2.5 px-3 text-slate-400">K-water 페이로드 → SSO 세션 생성 → CMP 토큰 발급 <span className="text-sky-300 font-mono text-[14px]">(Phase 1)</span></td>
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-2 flex items-center gap-2">
                <span className="bg-purple-500/20 text-purple-300 text-[14px] font-mono px-2 py-0.5 rounded">DIFF</span>
                진짜 차이 — OIDC 메커니즘이 아니라 역할
              </h5>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="bg-slate-950/60 border border-sky-500/30 rounded-xl p-3.5">
                  <div className="text-[14px] font-mono font-bold uppercase tracking-widest text-sky-300 mb-1">① K-water 페이로드 진입점</div>
                  <p className="text-[15px] text-slate-300 leading-relaxed">K-water는 RP 등록 시 CMP 콜백 URL(<code className="text-sky-300 text-[14px]">cmp.kwater.com/callback</code>) 하나만 받음. K-water 인증이 끝나면 <strong className="text-white">항상 CMP로 먼저 옴</strong>.</p>
                </div>
                <div className="bg-slate-950/60 border border-indigo-500/30 rounded-xl p-3.5">
                  <div className="text-[14px] font-mono font-bold uppercase tracking-widest text-indigo-300 mb-1">② 마스터 포털 역할</div>
                  <p className="text-[15px] text-slate-300 leading-relaxed">CMP는 사용자가 다른 포털로 갈지 선택하는 <strong className="text-white">허브 + 권한·리소스 관리 콘솔</strong>. 서브 포털은 특정 도메인 기능만 제공.</p>
                </div>
                <div className="bg-slate-950/60 border border-purple-500/30 rounded-xl p-3.5">
                  <div className="text-[14px] font-mono font-bold uppercase tracking-widest text-purple-300 mb-1">③ Scope 범위</div>
                  <p className="text-[15px] text-slate-300 leading-relaxed">CMP는 <code className="text-purple-300 text-[14px]">admin:*</code> 등 관리자 scope 허용. 서브 포털은 자기 도메인 scope만 (<code className="text-purple-300 text-[14px]">datahub:read</code> 등) — IdP가 client_id별로 제한.</p>
                </div>
              </div>
            </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
                <span className="bg-indigo-500/20 text-indigo-300 text-[14px] font-mono px-2 py-0.5 rounded">FLOW</span>
                무중단 인증 5단계
              </h5>
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-2 flex items-center gap-2">
                <span className="bg-emerald-500/20 text-emerald-300 text-[14px] font-mono px-2 py-0.5 rounded">REQUEST</span>
...
# prompt=none — 사용자에게 UI를 띄우지 말고 백그라운드로만 인증 시도`} />
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
                <span className="bg-rose-500/20 text-rose-300 text-[14px] font-mono px-2 py-0.5 rounded">ERROR</span>
                실패 시 응답 (Error Codes)
              </h5>
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs border-collapse text-slate-300">
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
                <span className="bg-purple-500/20 text-purple-300 text-[14px] font-mono px-2 py-0.5 rounded">PATTERN</span>
                구현 패턴 두 가지
              </h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="bg-slate-950/60 border border-emerald-500/30 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-[14px] font-mono font-bold bg-emerald-500/20 text-emerald-300 px-2 py-0.5 rounded">(A) Top-level redirect</span>
                    <span className="text-[14px] text-emerald-400 font-semibold">권장</span>
                  </div>
  ...
  'https://auth.kwater.com/oauth2/v1/authorize?...&prompt=none'`} /></div>
                  <p className="text-[15px] text-slate-400 leading-relaxed">짧은 깜빡임은 있지만 안전. 가이드의 React 예제(구현 예제 코드 탭)가 이 방식입니다.</p>
                </div>
                <div className="bg-slate-950/60 border border-amber-500/30 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="text-[14px] font-mono font-bold bg-amber-500/20 text-amber-300 px-2 py-0.5 rounded">(B) Hidden iframe</span>
                  </div>
                  <div className="mb-2"><CodeBlock language="markup" fontSize="0.72rem" code={`<iframe src=
  'https://auth.kwater.com/oauth2/v1/authorize?...&prompt=none' />`} /></div>
                  <p className="text-[15px] text-slate-400 leading-relaxed">깜빡임 없음. 단, IdP가 <code className="text-amber-300">frame-ancestors</code> 화이트리스트에 sub-portal 도메인을 허용해야 함. <code className="text-amber-300">postMessage</code>로 부모 윈도우에 code 전달.</p>
                </div>
              </div>
            </div>
            ...
            <div>
              <h5 className="text-sm font-bold text-white mb-3 flex items-center gap-2">
                <span className="bg-rose-500/20 text-rose-300 text-[14px] font-mono px-2 py-0.5 rounded">SECURITY</span>
                보안 체크리스트
              </h5>
